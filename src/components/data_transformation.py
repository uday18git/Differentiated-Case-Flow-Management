...
from sklearn.preprocessing import OneHotEncoder,StandardScaler # one hot is used to encode categorical variables and standard scalar is used to make the data unit gaussian
